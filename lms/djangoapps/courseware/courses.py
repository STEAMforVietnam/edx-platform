...
_Assignment = namedtuple(
    'Assignment', ['block_key', 'title', 'url', 'date', 'contains_gated_content', 'complete', 'past_due', 'section_name', 'earned', 'possible']
)
        ...
        for subsection_key in block_data.get_children(section_key):
            ...
            if due:
                ...
                assignments.append(_Assignment(
                    subsection_key, title, url, due, contains_gated_content, complete, past_due, section_name, grade.earned, grade.possible
                ))
